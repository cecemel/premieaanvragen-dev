...
ELASTIC_CONTAINER_NAME = "premieaanvragen-elastic-init"
ELASTIC_DATA = "$(pwd)/data/elastic"
STORAGE_PROVIDER_IMAGE = "premieaanvragen-dev/storageprovider:latest"
STORAGE_PROVIDER_CONTAINER_NAME = "storageprovider-init"
STORAGE_PROVIDER_DATA = "$(pwd)/data/storageprovider"
STORAGE_PROVIDER_DATA_MAP = "{}:/premieaanvragen_store".format(STORAGE_PROVIDER_DATA)
REDIS_IMAGE = "redis"
REDIS_CONTAINER_NAME = "premieaanvragen-redis-init"
...
def start_redis():
    ...
    _exec_command("docker run "
                  "--link {}:redis "
                  "premieaanvragen-dev/redis-checker:latest"
...
def start_storage_provider():
    ...
    _exec_command("docker run "
                  ...
                  "premieaanvragen-dev/storageprovider-checker:latest"
...
def start_elastic():
    ...
    _exec_command("docker run "
                  "--link {}:elastic "
                  "premieaanvragen-dev/elastic-checker:latest"
